...
class GameView(ft.UserControl):
    def __init__(self, game: Game):
        ...
        self._header = ft.Text(
            "Auswertung", visible=False, size=20, weight=ft.FontWeight.BOLD
        )
        ...
        self._questions_table = ft.DataTable(
            columns=[
        ...
        self._start_button = ft.ElevatedButton("Los", on_click=self._on_start_click)
